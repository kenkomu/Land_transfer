...
import { createContext, createMemo, useContext, splitProps, mergeProps, createSignal, children, Show, createComputed, batch, createEffect, untrack, onCleanup, createSelector, For, getOwner, runWithOwner } from 'solid-js';
...
const Carousel = p => {
  ...
  createEffect(() => {
    ...
    untrack(() => {
      local.onSlide?.(active, direction);
      local.onSlid?.(active, direction);
    });
  });
