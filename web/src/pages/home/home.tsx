...
<body class="int_dark_bg">
    ...
    <div id="wrapper" class="int_main_wraapper">
            ...
            <div id="header" class="int_content_wraapper hd">
                <div class="container container-header">
                    ...
                    <div class="left-side">
                        {/* Logo */}
                        <div id="logo">
                            <a href="index.html"><img src="images/logo-white-1.svg" data-sticky-logo="images/logo-white-1.svg" alt=""/></a>
                        </div>
                        {/* Mobile Navigation */}
                        ...
                        <nav id="navigation" class="style-1 black">
                            <ul id="responsive">
                                <li><a href="index-13.html#">Home</a>
                                   
                                    </li>
                                   
                                    <li><a href="index-13.html#">Property</a>
                                        <li><a href="index-13.html#">Buyer</a>
                                            <li><a href="index-13.html#">Seller</a>
                                            ...
                                            <div class="swiper-slide">
                                                <div class="swiper_imgbox imgbox1">
                                                    <div class="swipper_img">
                                                        ...
                                                        <p><i class="fa fa-map-marker mr-3"></i>Nairobi, Kenya</p>
                                                        {/* homes List */}
                                                        ...
                                                        <a href="single-property-1.html" class="int_btn">View Land <span class="btn_caret"><i class="fas fa-caret-right"></i></span></a>
                                                        <h1>Real</h1>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="swiper-slide">
                                                <div class="swiper_contbox">
                                                    <div class="swipper_conntent">
                                                        <img src="images/slider/img2.jpg" class="img-fluid " alt="images" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="swiper-slide">
                                                <div class="swiper_contbox">
                                                    <div class="swipper_conntent">
                                                        <img src="images/slider/img1.jpg" class="img-fluid" alt="images" />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <div class="slick-lancers">
                        <div class="agents-grid">
                            <div class="landscapes listing-item compact thehp-1" data-aos="fade-up" data-aos-delay="150">
                                <a href="single-property-1.html" class="recent-16">
                                    <div class="recent-img16 img-fluid img-center" style="background-image: url(images/feature-properties/img3.jpg);"></div>
                                    ...
                                    <div class="recent-details">                                        
                                        ...
                                        <div class="house-details thehp-1"><i class="fa fa-bath mr-1" aria-hidden="true"></i>Water & Electricity<span>|</span><i class="fa fa-object-group mr-1" aria-hidden="true"></i> 50 by 100</div>
                                    </div>
                        ...
                        <div class="agents-grid" data-aos="fade-up" data-aos-delay="250">
                            <div class="people listing-item compact thehp-1">
                                <a href="single-property-1.html" class="recent-16">
                                    <div class="recent-img16 img-center" style="background-image: url(images/feature-properties/img4.jpg);"></div>
                                    <div class="recent-content"></div>
                                    <div class="listing-badges">
                                        <span>For Sale</span>
                                    </div>
                        ...
                        <div class="agents-grid" data-aos="fade-up" data-aos-delay="350">
                            <div class="people landscapes no-pb pbp-3 listing-item compact thehp-1">
                                <a href="single-property-1.html" class="recent-16">
                                    <div class="recent-img16 img-center" style="background-image: url(images/feature-properties/img10.jpg);"></div>
                                    <div class="recent-content"></div>
                                    <div class="listing-badges">
                                        <span>For Sale</span>
                                    </div>
                        ...
                        <div class="agents-grid" data-aos="fade-up" data-aos-delay="450">
                            <div class="landscapes listing-item compact thehp-1">
                                <a href="single-property-1.html" class="recent-16">
                                    <div class="recent-img16 img-center" style="background-image: url(images/interior/img5.jpg);"></div>
                                    <div class="recent-content"></div>
                                    <div class="listing-badges">
                                        <span>For Sale</span>
                                    </div>
                        ...
                        <div class="agents-grid" data-aos="fade-up" data-aos-delay="550">
                            <div class="people listing-item compact thehp-1">
                                <a href="single-property-1.html" class="recent-16">
                                    <div class="recent-img16 img-center" style="background-image: url(images/interior/img11.jpg);"></div>
                                    <div class="recent-content"></div>
                                    <div class="listing-badges">
                                        <span>For Sale</span>
                                    </div>
                    ...
                    <div class="col-lg-3 col-md-12 m-top-0 m-bottom-40" data-aos="fade-up" data-aos-delay="150">
                        <div class="service bg-light-2 border-1 border-light box-shadow-1 box-shadow-2-hover">
                            ...
                            <div class="agent-section p-top-35 p-bottom-30 p-right-25 p-left-25">
                                ...
                                <a class="text-base text-base-dark-hover text-size-13" href="https://code-theme.com/html/findhouses/properties-full-list.html">Read More <i class="fa fa-long-arrow-right ml-2"></i></a>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="twitter-widget contuct">
                                    <div class="twitter-area">
                                        <div class="single-item">
                                            ...
                                            <div class="text">
                                                <h5><a href="index-13.html#">@findhouses</a> all share them with me baby said inspet.</h5>
        ...
        <a data-scroll href="index-13.html#wrapper" class="go-up"><i class="fa fa-angle-double-up" aria-hidden="true"></i></a>
        {/* END FOOTER */}
            ...
            <div class="main-register-holder">
                <div class="main-register fl-wrap">
                    ...
                    <div class="soc-log fl-wrap">
                        <p>Login</p>
                        <a href="index-13.html#" class="facebook-log"><i class="fa fa-facebook-official"></i>Log in with Facebook</a>
                        <a href="index-13.html#" class="twitter-log"><i class="fa fa-twitter"></i> Log in with Twitter</a>
                    </div>
